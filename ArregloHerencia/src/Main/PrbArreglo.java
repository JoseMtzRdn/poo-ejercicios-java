        ...
        do {
            ...
            switch (menu) {
                ...
                case 'M':
                    ...
                    MatrizEntero mE = new MatrizEntero(n, m);
                    do {
                        ...
                        switch (menu) {
                            ...
                            case 'a':
                                if (mE.getN() == 0 && mE.getM() == 0) {
                                    ...
                                    mE = new MatrizEntero(n, m);
                                }
                                mE.llenadoDatos(-99, 99);
                                break;
                            case 'U':
                            case 'u':
                                if (mE.getN() == 0 && mE.getM() == 0) {
                    ...
                    do {
                        ...
                        switch (menu) {
                            ...
                            case 'g':
                            case 'G':
                                nvoDato = new int[mE.getM()];
                                for (int i = 0; i < nvoDato.length; i++) {
                                    nvoDato[i] = Leer.leerInt("Ingrese nuevo dato en la posición [" + i + "]:");
                                }
                                mE.añadirFila(nvoDato);
                                break;
                            case 'h':
                            case 'H':
                                nvoDato = new int[mE.getN()];
                                for (int i = 0; i < nvoDato.length; i++) {
                                    nvoDato[i] = Leer.leerInt("Ingrese nuevo dato en la posición [" + i + "]:");
                                }
